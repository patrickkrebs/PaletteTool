...
A standalone browser app that turns a dragged image into an editable practical-color table, an aligned Markdown report, a Toon Boom Harmony 25 `.plt` palette, and a Photoshop `.aco` swatch set.
